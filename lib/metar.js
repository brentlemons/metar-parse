...
// var conditionsRegEx = /^(?< **1** wind>(?< **2** direction>\w{3}|\d{3})(?< **3** speed>\d{2})(?:G(?< **4** gustSpeed>\d{2}))?KT(?:\s(?< **5** variableOne>\d{3})V(?< **6** variableTwo>\d{3}))?)?(?:\s)?(?<visibility>(?:(?:(?:[0-9]{1,2})|(?:[0-9]{1,2}\\s[0-9]/[0-9])|(?:[0-9]/[0-9]))SM))?(?<other>.+)(?:\s(?:(?:(?<temperatureNegative>M)?(?<temperature>\d{2}))/(?:(?<dewPointNegative>M)?(?<dewPoint>\d{2}))))(?:\s(?:A(?<altimeter>\d{4})))(?<remainder>.*)$/;
...
var conditionsRegEx = /^((\w{3}|\d{3})(\d{2})(?:G(\d{2}))?KT(?:\s(\d{3})V(\d{3}))?).*$/;//    ?(?:\s)?(?<visibility>(?:(?:(?:[0-9]{1,2})|(?:[0-9]{1,2}\\s[0-9]/[0-9])|(?:[0-9]/[0-9]))SM))?(?<other>.+)(?:\s(?:(?:(?<temperatureNegative>M)?(?<temperature>\d{2}))/(?:(?<dewPointNegative>M)?(?<dewPoint>\d{2}))))(?:\s(?:A(?<altimeter>\d{4})))(?<remainder>.*)$/;
    /*
     * m[0] = wind
     * m[1] = direction
     * m[2] = speed
